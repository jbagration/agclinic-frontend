...
const MainSlider = ({ banners, apiUrl }: { banners: IBanners[]; apiUrl: string; }) => {
    ...
    let screenWidth = typeof window !== "undefined" ? window.innerWidth : 1600;
                ...
                >
                    <SliderBlock>
                        ...
                        <SContentSlide>
                            <a
                                ...
                                href='https://vk.com/video423368252_456239679'
                            >
                                <Image 
                                    src={findOutAboutUs}
                                    alt='findOutAboutUs'
                    ...
                    {banners.map(({id, desktop_img, mobile_img, url}) => (
                        <SliderBlock key={id}>
                            ...
                            >
                                <SSlide
                                    bg={`${apiUrl}/public/uploads/images/${desktop_img}?height=${screenWidth > 1440 ? 1184 : screenWidth > 1024 ? 813 : screenWidth > 768 ? 613 : 613}`}
                                    bgMob={`${apiUrl}/public/uploads/images/${mobile_img}?width=${screenWidth >= 768 ? 850 : screenWidth >= 600 ? 700 : screenWidth >= 400 ? 500 : 400}`}
                                />
                            </Link>
                        </SliderBlock>
                    ))}
